...
namespace Zyronaa.SDK.Plugins.Configuration
{
	...
	{
		/// <summary>
		/// The default name of the Zyronaa definition file.
		/// </summary>
		public const string DefinitionFile = "zyronaa.yml";

		/// <summary>
		/// The default name of the Zyronaa lock file
		/// </summary>
		public const string LockFile = "zyronaa.lock";
		...
		/// <summary>
		/// The default path to the Zyronaa plugins directory
		/// </summary>
		public const string PluginPath = "plugins";

		/// <summary>
		/// The default path to the Zyronaa configuration directory
		/// </summary>
